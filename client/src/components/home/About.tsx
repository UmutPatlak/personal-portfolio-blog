    ...
    <section id="about" className="relative overflow-hidden py-16 sm:py-20 lg:py-28 w-full">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          {/* Text Story — slides in from left with blur */}
          <ScrollReveal
            direction="left"
            effect="blur"
            distance={50}
          ...
          >
            <motion.p
              ...
              className="p-4 sm:p-5 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] shadow-sm"
            >
              {t('about.paragraph1')}
            </motion.p>
            <motion.p
          ...
          {/* Key Stats — staggered scale-up from right */}
          <ScrollReveal
            stagger
            staggerDelay={0.12}
            delay={0.2}
