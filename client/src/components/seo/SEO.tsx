...
export function SEO({
  ...
  return (
    <Helmet>
      ...
      {fullImage.endsWith('.png') && <meta property="og:image:type" content="image/png" />}
      {(fullImage.endsWith('.jpg') || fullImage.endsWith('.jpeg')) && <meta property="og:image:type" content="image/jpeg" />}
      {fullImage.endsWith('.svg') && <meta property="og:image:type" content="image/svg+xml" />}
      {fullImage.endsWith('.webp') && <meta property="og:image:type" content="image/webp" />}
      ...
      <meta name="twitter:site" content="@umutpatlak" />
    </Helmet>
  );
}
